...
def compress():
    if request.method == 'POST':
        if 'image' not in request.files:
            return render_template('compress.html', results=None, error="No image uploaded")
        
        file = request.files['image']
        if file.filename == '':
            return render_template('compress.html', results=None, error="No image selected")
        ...
        if file:
            ...
            try:
                ...
                return render_template('compress.html', results=None, error=f"Error loading image: {str(e)}")
            ...
            try:
                ...
                return render_template('compress.html', results=None, error="Invalid k value. Please enter a positive integer.")
